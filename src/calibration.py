...
if __name__ == "__main__":
    ...
    print(os.getcwdb())
    image_files = glob.glob('/home/pi/Desktop/ProyectoFinal_CV/data/images/calibration/*.jpg')
    ...
    chessboard_points = [get_chessboard_points(patternSize, 24, 24) for _ in range(len(corners_refined))]
    ...
    output_dir = "/home/pi/Desktop/ProyectoFinal_CV/data/images/calibration_results"
